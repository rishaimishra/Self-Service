...
public class WasteManagementFragment extends Fragment {
    private RecyclerView rvWasteManagement;
    private ArrayList<String> wasteManagementList;
    private RecyclerView rvImages;
    private JustifiedTextView tvInfo;
    public static WasteManagementFragment newInstance(){
        return new WasteManagementFragment();
    }
    ...
    private void initToolbar(View view){
        ...
        tvTitle.setText("Waste Management");
    ...
    private void initView(View view) {
        rvWasteManagement = view.findViewById(R.id.rvDemandNote);
        rvImages = view.findViewById(R.id.rvImages);
        tvInfo = view.findViewById(R.id.tvInfo);
        tvInfo.setText(getString(R.string.waste_management_info));
        setData();
    }
    private void setData() {
        wasteManagementList = new ArrayList<>();
        wasteManagementList.add("No Waste Dump in my Ward");
        wasteManagementList.add("No Waste Dump in my Area/Section");
        wasteManagementList.add("Waste Management Hazard");
        setAdapter();
        setImagesAdapter();
    }

    private void setAdapter(){
        RadioButtonAdapter adapter=new RadioButtonAdapter(requireActivity(), wasteManagementList, (view, position) -> {


        });
        LinearLayoutManager layoutManager=new LinearLayoutManager(requireActivity());
        rvWasteManagement.setLayoutManager(layoutManager);
        rvWasteManagement.setAdapter(adapter);
    }
