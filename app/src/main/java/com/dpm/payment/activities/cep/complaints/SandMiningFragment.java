...
public class SandMiningFragment extends Fragment {
    private RecyclerView rvWater;
    private ArrayList<String> waterList;
    private RecyclerView rvImages;
    private JustifiedTextView tvInfo;
    public static SandMiningFragment newInstance(){
        return new SandMiningFragment();
    }
    ...
    private void initView(View view) {
        ...
        tvInfo.setText(getString(R.string.sand_mining_info));
        setData();
    }
    private void setData() {
        waterList = new ArrayList<>();
        waterList.add("Sand mining activities");
        waterList.add("Sand mining hazards");
        setAdapter();
        setImagesAdapter();
    }
