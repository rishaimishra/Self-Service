...
public class ElectricityFragment extends Fragment {
    private RecyclerView rvElectricityNote;
    private ArrayList<String> electricityList;
    ...
    private void initView(View view) {
        rvElectricityNote = view.findViewById(R.id.rvDemandNote);
        rvImages = view.findViewById(R.id.rvImages);
        tvInfo = view.findViewById(R.id.tvInfo);
        tvInfo.setText(getString(R.string.electricity_info));
        setData();
    }
    private void setData() {
        electricityList = new ArrayList<>();
        electricityList.add("No Electricity in my Ward");
        electricityList.add("No Electricity in my Area/Section");
        electricityList.add("Electricity Hazard");
        setAdapter();
        setImagesAdapter();
    }

    private void setAdapter(){
        RadioButtonAdapter adapter=new RadioButtonAdapter(requireActivity(), electricityList, (view, position) -> {


        });
        LinearLayoutManager layoutManager=new LinearLayoutManager(requireActivity());
        rvElectricityNote.setLayoutManager(layoutManager);
        rvElectricityNote.setAdapter(adapter);
    }
