...
public class DemandNoteFragment extends Fragment {
    ...
    private void setData() {
        demandNoteList = new ArrayList<>();
        demandNoteList.add("Assessment parameters not correct");
        demandNoteList.add("Ownership details not correct");
        demandNoteList.add("Address not correct");
        setAdapter();
        setImagesAdapter();
    }
    ...
    private void setAdapter(){
        ...
        rvDemandNote.setLayoutManager(layoutManager);
        rvDemandNote.setAdapter(adapter);
    }
